import { MemberExtraction } from './MemberExtraction';
...
export class KNNQuery extends EventEmitter {  
  MAXKNNITEMS = 50
  ...
  async queryTreeKNN(collectionId: any, long: any, lat: any, session = null){
